# LAB: Addressing VNets overlapping IP using VPN Gateways using NAT and BGP

## Intro

In this lab, we're going over how to connect two or more VNETs with overlapping IP using native VPN Gateways only.
If you are not familiar with the VPN Gateways NAT feature, I recommend you review the following document: [About NAT on Azure VPN Gateway](https://learn.microsoft.com/en-us/azure/vpn-gateway/nat-overview)

### Network topology

![Network Diagram](../media/2-bgp-network-diagram.png)
